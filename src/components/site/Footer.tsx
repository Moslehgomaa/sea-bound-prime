...
const socials = [
  { Icon: Linkedin, href: "https://www.linkedin.com/company/blue-ocean-marine", label: "LinkedIn" },
  { Icon: Facebook, href: "https://www.facebook.com/blueoceanmarine", label: "Facebook" },
];
      ...
      <div className="container-x grid gap-10 py-16 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="mt-5 flex gap-3">
            {socials.map(({ Icon, href, label }) => (
              <a
                ...
                aria-label={`Blue Ocean Marine on ${label}`}
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-primary-foreground/85">
            <li className="flex gap-2.5"><MapPin className="h-4 w-4 mt-0.5 shrink-0" /><span>Alexandria, Egypt</span></li>
            <li className="flex gap-2.5"><Phone className="h-4 w-4 mt-0.5 shrink-0" /><span>+20 3 484 1223</span></li>
            <li className="flex gap-2.5"><Mail className="h-4 w-4 mt-0.5 shrink-0" /><span>info@blueoceanmarine.com.eg</span></li>
            <li className="flex gap-2.5"><Phone className="h-4 w-4 mt-0.5 shrink-0" /><span>24/7 Emergency: +20 106 261 4443</span></li>
          </ul>
        </div>
      </div>
